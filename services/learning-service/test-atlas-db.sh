#!/bin/bash
# Test script for user lesson progress system with MongoDB Atlas
...
# For local testing, you can set them here or in a .env file
...
echo "Starting learning service with MongoDB Atlas connection..."
...
curl -X GET "${API_URL}/lessons/lesson-1" | jq .
